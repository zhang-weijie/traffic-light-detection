...
#### Lösung: Auswahl mehrerer Bilddateien
![extraTask-loesung1](bilder/extraResult1.png)
#### Lösung: Aktuelles Bild
![extraTask-loesung2](bilder/extraResult2.png)
#### Lösung: Nächstes Bild
![extraTask-loesung3](bilder/extraResult3.png)
#### Lösung: Voriges Bild
![extraTask-loesung4](bilder/extraResult4.png)
#### Lösung: GIF-Demo
![extraTask-loesung5](bilder/multi_images.gif)
